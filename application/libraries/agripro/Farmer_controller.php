...
class Farmer_controller {
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','fm_name');
        ...
        try {
            ...
            if(!empty($searchPhrase)) {
                $table->setCriteria("(fm_code ilike '%".$searchPhrase."%' OR fm_name ilike '%".$searchPhrase."%')");
            }
