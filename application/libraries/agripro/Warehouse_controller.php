...
class Warehouse_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','wh_id');
    ...
    function readLov() {
        ...
        $sort = getVarClean('sort','str','wh_id');
        ...
        try {
            ...
            if(!empty($searchPhrase)) {
                $table->setCriteria("wh_code ilike '%".$searchPhrase."%'");
            }
    ...
    function html_select_options() {
        ...
        try {
            ...
            foreach($items as $item) {
                echo '<option value="'.$item['wh_id'].'"> '.$item['wh_code'].' - '.$item['wh_name'].' </option>';
            }
            echo '</select>';
            exit;
        }catch (Exception $e) {
