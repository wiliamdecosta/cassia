...
<script>
	...
	/* ------------------------------  detail grid --------------------------------*/
        jQuery("#grid-table-detail").jqGrid({
            ...
            mtype: "POST",
            colModel: [
                {label: 'ID', key:true, name: 'groups_permissions_id', width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Permission ID',  name: 'permission_id', width: 5, sorttype: 'number',editable: true, hidden: true},
				{label: 'Group ID', name: 'group_id', width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Permission Name', name: 'permission_name', width: 120, align: "left", editable: false},
            ...
            //memanggil controller jqgrid yang ada di controller crud
            editurl: '<?php echo WS_JQGRID."administration.groups_permissions_controller/crud"; ?>',
...

            {
				editData: {
					group_id: function() {
						...
						var group_id = $("#grid-table").jqGrid('getCell', selRowId, 'id');
						return group_id;
					}
                },
                // options for the Edit Dialog
